		...
		<div class="container"><!--içerik kısmındaki yazıların düzenli ve ortalı olarak görünmesini sağlayan div-->
            ...
            <ul style="margin-bottom:10px; list-style:none">
            	...
            	<?php
					...
					$sqlcumlesi="Select * from tbl_altkategoriler where AltId='$getid'";
					...
					$say=mysql_num_rows($sql);
						...
						for($i=0;$i<$say;$i++){
							...
							echo "<h5><li style='background-color:#E8E8E8; border:1px dashed silver;'>".$vericek['AltKategoriAdi']."</a></li></h5>";
												
												}
											
						$sqlcumlesi2="Select * from tbl_paylasimlar where AltId='$getid'";
						...
						$say2=mysql_num_rows($sql2);
								...
								for($j=0;$j<$say2;$j++){
									...
									echo "<li style='background-color:#F7F7F7; border:1px dotted silver; margin-left:25px; margin-top:10px'>►<a href='kategori.php?Id=$id'>".$vericek2['Baslik']."</a></li>";
